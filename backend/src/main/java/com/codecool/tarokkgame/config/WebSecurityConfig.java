package com.codecool.tarokkgame.config;

import com.codecool.tarokkgame.security.jwt.AuthEntryPointJwt;
import com.codecool.tarokkgame.security.jwt.AuthTokenFilter;
import com.codecool.tarokkgame.security.jwt.JwtUtils;
import com.codecool.tarokkgame.security.service.UserDetailsServiceImpl;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtUtils jwtUtils) throws Exception {
        return http
                ...
                .cors(Customizer.withDefaults())//.cors(cors -> {})
